...
class ElevatedRectangleButton extends StatelessWidget {
  ...
  const ElevatedRectangleButton({super.key, required this.label, required this.disabled, this.onPressed,});
  ...
  style: ElevatedButton.styleFrom(
    ...
    shape: RoundedRectangleBorder(side: BorderSide(width: boderWidth, color: boderColor,),borderRadius: BorderRadius.circular(boderRadius),
    ),
  ),
